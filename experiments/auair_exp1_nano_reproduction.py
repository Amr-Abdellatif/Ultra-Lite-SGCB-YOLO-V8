...
from auair_common import BASE_CONFIG, REPO_ROOT, model_cfg_dir, print_multi_comparison, save_comparison_csv, train_model


def main() -> int:
    parser = argparse.ArgumentParser(description="AU-AIR Experiment 1: Nano controlled comparison")
    parser.add_argument("--epochs", type=int, default=300)
    parser.add_argument("--device", type=str, default="0")
    parser.add_argument("--batch", type=int, default=30)
    parser.add_argument("--imgsz", type=int, default=384)
    parser.add_argument("--project", type=str, default="Comparison_AU-AIR_Exp1")
